// 资料 编辑 详情
<template>
  <div v-loading="loading" class="contentWrap personneEdit">
    <el-form ref="ruleForm" :model="ruleForm" label-width="160px" sizi="mini" :inline="false" :rules="rules" class="demo-ruleForm" style="width:682px;margin:0 auto;">
      <div class="titleWrap">
        <h2 class="title">基本信息</h2>
        <div class="overflow">
          <div class="leftWrap">
            <el-form-item label="身份证号:" prop="idNum">
              <el-input ref="idNumClass" v-model="ruleForm.idNum" :disabled="!isEdit" @blur="handleGetdata" />
            </el-form-item>
            <el-form-item label="姓名:" prop="ename">
              <el-input v-model="ruleForm.ename" :disabled="!isEdit" />
            </el-form-item>
        ...
        <el-form-item label="副联系电话:" prop="phone2">
          <el-input v-model="ruleForm.phone2" />
        </el-form-item>
      ...
      <div v-if="ruleForm.station =='施工队长' || ruleForm.station =='施工人员'" class="titleWrap workTypeArray">
      ...
      <div v-if="ruleForm.station =='工程管理'" class="titleWrap workTypeArray">
    ...
    <div v-if="empOrtherId || empId" class="footerBtn center">
...
export default {
  ...
  created() {
    ...
    // 是否允许编辑 true 为人员添加 false 为编辑
    this.isEdit = !(this.empId || this.empOrtherId)
  ...
  methods: {
    ...
    handleGetdata() {
      ...
      if (this.ruleForm.idNum && idNumReg.test(this.ruleForm.idNum)) {
        const param = this.ruleForm.idNum
