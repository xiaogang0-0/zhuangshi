...
<template>
  <div class="contentWrap perfectInformation">
    ...
    <div class="contWrap" >
      ...
      <p class="center lineHeight30 padBot10">非上海市装饰装修行业协会会员的企业由此进入</p>
      <el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" class="demo-ruleForm">
        <el-form-item label-width="150px" label="企业营业执照:" prop="businessLicense" >
          <span 
            ...
            <span 
                ...
                :key="index2+ele"
                @click="handlePreviewImg(ele.url)">企业营业执照{{index2+1}}</span>
        </el-form-item>

        <el-form-item label-width="150px" label="统一信用代码:" prop="invoiceNum">
          <el-input v-model.trim="ruleForm.invoiceNum" clearable placeholder="请输入统一信用代码"></el-input>
        </el-form-item>
        ...
        <el-form-item label-width="150px" label="上海市装饰装修行业协会会员证书号:" prop="invoiceAmount">
          <el-input v-model.trim="ruleForm.invoiceAmount" clearable placeholder="上海市装饰装修行业协会会员证书号"></el-input>
        </el-form-item>

         <el-form-item label-width="150px" label="上传施工资质证书:" prop="img" >
          <span 
            class="btn"
            @click="handleUploadModal(ruleForm.img,1)">&nbsp;&nbsp;点击上传&nbsp;&nbsp;</span>
          <span 
              class="btn"
              v-for="(ele, index2) in ruleForm.img"
              :key="index2+ele"
              @click="handlePreviewImg(ele.url)">施工资质证书{{index2+1}}</span>
        </el-form-item>
        ...
        <el-form-item label-width="150px" label="施工资质发放单位:" prop="invoiceType">
          <el-select v-model="ruleForm.invoiceType" placeholder="请选择">
        ...
        <el-form-item label-width="150px" label="施工资质或施工能力等级评价:" prop="invoiceAddress">
          <el-select v-model="ruleForm.invoiceAddress" placeholder="请选择">
         ...
         <el-form-item label-width="150px" label="施工资质证书编号:" prop="taxNumber">
          <el-input v-model.trim="ruleForm.taxNumber" clearable placeholder="上海市装饰装修行业协会会员证书号"></el-input>
        </el-form-item>
        ...
        <el-form-item label-width="150px" label="企业法人:" prop="invoiceBank">
          <el-input v-model.trim="ruleForm.invoiceBank" clearable placeholder="请输入企业法人"></el-input>
        </el-form-item>

        <el-form-item label-width="150px" label="法人身份证号:" prop="title">
          <el-input v-model.trim="ruleForm.title" clearable placeholder="请输入法人身份证号"></el-input>
        </el-form-item>
        
        <el-form-item label-width="150px" label="法人证照:" prop="invoiceBankNum" style="border:none">
          <span 
            class="btn"
            @click="handleUploadModal(ruleForm.invoiceBankNum,2)">&nbsp;&nbsp;点击上传&nbsp;&nbsp;</span>
          <span 
              class="btn"
    ...
    <div class="footerBtn">
      ...
      <span class="btn" @click="handleConfirmButtonClick">注 册</span>
...
export default {
  ...
  created() {
    // let date = sessionStorage.getItem('siw_perfectInformation')
    // sessionStorage.removeItem('siw_perfectInformation')
    // if(date){
