    ...
    <div class="contWrap" >
      ...
      <el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" class="demo-ruleForm">
        ...
        <el-form-item label-width="150px" label="公司全称:" prop="fullName">
          <el-input  v-if="editStatus.status1" v-model.trim="ruleForm.name" clearable placeholder="公司全称"></el-input>
        ...
        <el-form-item label-width="150px" label="统一社会信用代码:" prop="creditCode">
          <el-input v-if="editStatus.status2" v-model.trim="ruleForm.creditCode" clearable placeholder="请输入统一社会信用代码"></el-input>
        ...
        <el-form-item label-width="150px" label="企业法人:" prop="legalPerson">
          <el-input v-if="editStatus.status4" v-model.trim="ruleForm.legalPerson" clearable placeholder="请输入企业法人"></el-input>
        ...
        <el-form-item label-width="150px" label="法人身份证号:" prop="idNum">
          <el-input v-if="editStatus.status5" v-model.trim="ruleForm.idNum" clearable placeholder="请输入法人身份证号"></el-input>
        ...
        <el-form-item label-width="150px" label="上海市装饰装修行业协会会员证书号:" prop="certificateNum">
          <el-input  v-if="editStatus.status9" v-model.trim="ruleForm.certificateNum" clearable placeholder="上海市装饰装修行业协会会员证书号"></el-input>
        ...
        <el-form-item label-width="150px" label="施工资质证书:" prop="qualificationPhoto" style="border:none">
          ...
          <span 
            ...
            class="btn"
            @click="handleUploadModal(ruleForm.qualificationPhoto,1)">&nbsp;&nbsp;点击更换&nbsp;&nbsp;</span>
          <span v-else class="inlineBlock"></span>
...
export default {
  ...
  methods: {
    ...
    handleModifyPost(){
      ...
      let obj1= Object.assign({},JSON.parse(JSON.stringify(this.ruleForm))) 
      let obj2= Object.assign({},JSON.parse(JSON.stringify(this.details))) 
